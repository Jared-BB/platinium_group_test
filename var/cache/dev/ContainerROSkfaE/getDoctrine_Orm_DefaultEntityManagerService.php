...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Domain/Model')], false), 'App\\Domain\\Model');

        $a->setEntityNamespaces(['App' => 'App\\Domain\\Model']);
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Infrastructure\\Persistence\\Doctrine\\Repository\\Product\\MysqlProductRepository' => ['privates', 'App\\Infrastructure\\Persistence\\Doctrine\\Repository\\Product\\MysqlProductRepository', 'getMysqlProductRepositoryService', true],
        ], [
            'App\\Infrastructure\\Persistence\\Doctrine\\Repository\\Product\\MysqlProductRepository' => '?',
        ])));
